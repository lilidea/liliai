...
const About1 = () => {
  ...
  const { aboutText, primaryColor } = siteData;
    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-6 max-w-4xl text-center">
        ...
        <p className="text-xl text-gray-700 leading-loose">
          {aboutText || "2024 yılında kurulan şirketimiz, yenilikçi çözümlerle müşterilerine değer katmayı hedeflemektedir. Profesyonel ekibimiz ve sektördeki deneyimimizle her zaman en iyisini sunmak için çalışıyoruz."}
        </p>
      </div>
    </section>
  );
